/* global $, L, school, commute */
// File follows https://standardjs.com/
$(document).ready(function () {
  ...
  info.update = function (props, scenario) {
    ...
    if (scenario !== undefined && props) {
      regionText = '<b>' + capitalize(props.region_name) + '</b><br />' + preciseRound(props[scenario], 1) + '  % in ' + info.scenarioMap[scenario]
    } else {
  ...
  for (var prop in info.scenarioMap) {
    if (Object.prototype.hasOwnProperty.call(info.scenarioMap, prop)) {
  ...
  legend.onAdd = function (map) {
    ...
    var grades = [0, 2, 4, 7, 10, 15, 20, 25, 30, 40]
    var binLabels = ['0-1%',
      '2-3%',
      '4-6%',
      '7-9%',
