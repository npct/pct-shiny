...
Tool (PCT). The aim is clarify doubts that some have had about what the tool is,
how it works, and why it was designed in this way.
...
can be seen in the [Model Output Tab](#tab-9331-4).
