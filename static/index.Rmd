...
<!--Don't edit this file directly. Edit the .Rmd version which compiles into index.html:
...
Welcome to the National Propensity to Cycle Tool (PCT), an online and interactive planning support tool to provide an evidence base to inform investment in cycling. For more information about the tool please refer to the [Manual](http://pct.bike/manual.html), an [academic paper](http://arxiv.org/abs/1509.04425) about the PCT or the [about page](http://pct.bike/about.html).

To run the tool for England (PCT-England), click on a region in the map to the left. **Note: you need a good internet connection for the PCT to run, i.e. not via a mobile device**.
...
# new meta logo
knitr::include_graphics("https://cloud.githubusercontent.com/assets/11028720/15325024/d5e38f7c-1c40-11e6-9dd3-4567edaba8d5.png")
```
