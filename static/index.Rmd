...
Welcome to the National Propensity to Cycle Tool (PCT), an online and interactive planning support tool to provide an evidence base to inform investment in cycling. For more information about the tool please refer to the [Manual](http://pct.bike/manual.html), an [academic paper](http://arxiv.org/abs/1509.04425) about the PCT, the [about page](http://pct.bike/about.html) or the [PCT blog](http://pct.bike/wp/)

To run the tool for England (PCT-England), click on a region in the map to the left.
