...
<!--Warning: do not edit the manual.html document directly. Edit manual.Rmd-->
...
<td style="vertical-align: top; width: 535px;">![Scenario Selection](./assets/help/scenario-selection.png)  
</td>
...
<td style="vertical-align: top; width: 535px;">![Zone Attribute](./assets/help/zone-attribute.png)  
</td>
...
<td style="vertical-align: top; width: 535px;">![Cycling Flows](./assets/help/cycling-flows.png)  
</td>
...
<td style="vertical-align: top; width: 535px;">![Fixed Lines](./assets/help/freeze-lines.png)  
</td>
...
<td style="vertical-align: top; width: 535px;">![Line Attribute](./assets/help/line-attribute.png)  
</td>
...
<td style="vertical-align: top; width: 535px;">![Number of Lines to Show](./assets/help/number-of-lines.png)  
</td>
...
<td style="vertical-align: top; width: 535px;">![Direct Route](./assets/help/direct-route.png)  
</td>
...
<td style="vertical-align: top;">![Quiet Route](./assets/help/quiet-route.png)  
</td>
...
<td style="vertical-align: top;">![Straight Line](./assets/help/straight-line-popup.png)  
</td>
...
<td style="vertical-align: top;">![Zone](./assets/help/zone-popup.png)  
</td>
...
<td style="vertical-align: top;">![Legend](./assets/help/legend.png)</td>
...
<td align="center" valign="center">[![](./assets/FAQs/Fig0.png)](./assets/FAQs/Fig0.png "Figure 1: Proportion of trips cycled in England, according to the hilliness of the local area")   
</td>
...
<td align="center" valign="center">[![](./assets/FAQs/Fig1.png)](./assets/FAQs/Fig1.png "Figure 2: Distribution of the population of the Netherlands in terms of the hilliness of their local area, relative to the tenths defined in England.") </td>
...
<td align="center" valign="center">[![](./assets/FAQs/Fig2.png)](./assets/FAQs/Fig2.png "Figure 1: Proportion of trips cycled in England and Netherlands stratified by age and sex")   
</td>
...
<td align="center" valign="center">[![](./assets/FAQs/Fig3.png)  
](./assets/FAQs/Fig3.png "Figure 2: Ratio of cycle mode share in the Netherlands versus England, stratified by age and sex")</td>
...
<td align="center" valign="center">[![](./assets/FAQs/Fig4.png)](./assets/FAQs/Fig4.png "Figure 3: 'Distance decay' curves in England and the Netherlands, showing the probability that a trip of a given distance will be cycled relative to a trip of 2 miles")   
</td>
...
<td align="center" valign="center">[![](./assets/FAQs/Route.png)](./assets/FAQs/Route.png "Direct and Quiet Routes between two zones.")   
</td>
...
<<<<<<< HEAD
<script>(function () { var script = document.createElement("script"); script.type = "text/javascript"; script.src = "https://cdn.mathjax.org/mathjax/latest/MathJax.js?config=TeX-AMS-MML_HTMLorMML"; document.getElementsByTagName("head")[0].appendChild(script); })();</script>
=======
<script>(function () { var script = document.createElement("script"); script.type = "text/javascript"; script.src = "https://cdn.mathjax.org/mathjax/latest/MathJax.js?config=TeX-AMS-MML_HTMLorMML"; document.getElementsByTagName("head")[0].appendChild(script); })();</script>
...
f = gsub(pattern = '(?<=<img src=")(.*)(?=assets/help/)',
         replacement = "../regions_www/", f, perl = T)
...
f = c(f_head, f)
writeLines(f, "static/user-manual.html")
```
>>>>>>> master
