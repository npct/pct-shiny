...
This is work in progress and is being developed as part of a suite of training materials during 2016. To request more information or provide feedback, please [email us at pct@pct.bike](mailto:pct@pct.bike?Subject=Manual) or report issues on our [GitHub issue tracker](https://github.com/npct/pct-shiny/issues). Contributions to the project are welcome. This file, for instance, can be edited online at [github.com/npct/pct-shiny](https://github.com/npct/pct-shiny/edit/master/static/manual.Rmd).
...
The PCT works on a region-by-region basis. The url corresponds to the region you are looking at, which can be selected from the [home page](http://pct.bike). [pct.bike/west-yorkshire/](http://pct.bike/west-yorkshire/), for example, shows West Yorkshire. If you move the map's extent outside the region's boundary, the PCT will jump to a new region.
