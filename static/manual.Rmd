...
<a href="https://github.com/npct/pct-shiny/edit/master/static/manual.Rmd">github.com/npct/pct-shiny</a>.
...
The PCT works on a region-by-region basis. The url corresponds to the region you are looking at, which can be selected from the
 <a href="http://pct.bike">home page</a>. <a href="http://pct.bike/west-yorkshire/">pct.bike/west-yorkshire/</a>,
...
<a href="https://www.gov.uk/government/uploads/system/uploads/attachment_data/file/364791/141015_Cycling_Delivery_Plan.pdf">Cycling Delivery Plan</a>) to double cycling in England. Taking population increases and trip rate decreases into account, the target implies doubling the proportion of trips made by cycling nationwide. Trips that have a large distances or that already have a high rate of cycling will see cycling increase less than two-fold; trips with a below average current rate of cycling but high potential (based on the distance) will see cycling increase more than two-fold.
...
<a href="http://www.cyclestreets.net/journey/help/howitworks/">Cycle Streets Routing</a>
...
<a href="http://www.cyclestreets.net/journey/help/howitworks/">CycleStreets.net</a>
...
<a href="https://github.com/npct">github.com/npct</a>.
