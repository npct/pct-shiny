...
<td style="vertical-align: top; width: 535px;">![Scenario Selection](img/help/scenario-selection.png)  
</td>
...
<td style="vertical-align: top; width: 535px;">![Zone Attribute](img/help/zone-attribute.png)  
</td>
...
<td style="vertical-align: top; width: 535px;">![Cycling Flows](img/help/cycling-flows.png)  
</td>
...
<td style="vertical-align: top; width: 535px;">![Fixed Lines](img/help/freeze-lines.png)  
</td>
...
<td style="vertical-align: top; width: 535px;">![Line Attribute](img/help/line-attribute.png)  
</td>
...
<td style="vertical-align: top; width: 535px;">![Number of Lines to Show](img/help/number-of-lines.png)  
</td>
...
<td style="vertical-align: top; width: 535px;">![Direct Route](img/help/direct-route.png)  
</td>
...
<td style="vertical-align: top;">![Quiet Route](img/help/quiet-route.png)  
</td>
...
<td style="vertical-align: top;">![Straight Line](img/help/straight-line-popup.png)  
</td>
...
<td style="vertical-align: top;">![Zone](img/help/zone-popup.png)  
</td>
...
<td style="vertical-align: top;">![Legend](img/help/legend.png)</td>
...
<td align="center" valign="center">[![](img/help/Fig0.png)](img/help/Fig0.png "Figure 1: Proportion of trips cycled in England, according to the hilliness of the local area")   
</td>
...
<td align="center" valign="center">[![](img/help/Fig1.png)](img/help/Fig1.png "Figure 2: Distribution of the population of the Netherlands in terms of the hilliness of their local area, relative to the tenths defined in England.") </td>
...
<td align="center" valign="center">[![](img/help/Fig2.png)](img/help/Fig2.png "Figure 1: Proportion of trips cycled in England and Netherlands stratified by age and sex")   
</td>
...
<td align="center" valign="center">[![](img/help/Fig3.png)  
](img/help/Fig3.png "Figure 2: Ratio of cycle mode share in the Netherlands versus England, stratified by age and sex")</td>
...
<td align="center" valign="center">[![](img/help/Fig4.png)](img/help/Fig4.png "Figure 3: 'Distance decay' curves in England and the Netherlands, showing the probability that a trip of a given distance will be cycled relative to a trip of 2 miles")   
</td>
...
<td align="center" valign="center">[![](img/help/Route.png)](img/help/Route.png "Direct and Quiet Routes between two zones.")   
</td>
