...
manual_a_url <- paste("https://cdn.rawgit.com/npct/pct-shiny", repo_sha, "static", "pct-bike-user-manual-a.pdf", sep = "/")

manual_b_url <- paste("https://cdn.rawgit.com/npct/pct-shiny", repo_sha, "static", "pct-bike-user-manual-b.pdf", sep = "/")
```

<a target="_blank" href = "`r manual_a_url`">User Manual A</a>

<a target="_blank" href = "`r manual_b_url`">User Manual B</a>
